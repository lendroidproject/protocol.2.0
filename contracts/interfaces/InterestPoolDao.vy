...
@public
def initialize(_owner: address, _LST: address, _registry_pool_name: address, _dao_currency: address, _template_interest_pool: address, _template_token_erc20: address) -> bool:
    pass
...
@public
def register_pool(_accepts_public_contributions: bool, _currency: address, _name: string[64], _symbol: string[32], _initial_exchange_rate: uint256, _fee_percentage_per_i_token: uint256, _mft_expiry_limit: uint256) -> bool:
    pass

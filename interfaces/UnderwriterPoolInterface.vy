...
@public
def initialize(_dao_protocol: address, _accepts_public_contributions: bool, _operator: address, _fee_percentage_per_i_token: uint256, _fee_percentage_per_s_token: uint256, _mft_expiry_limit: uint256, _name: string[64], _initial_exchange_rate: uint256, _currency: address, _l_address: address, _i_address: address, _s_address: address, _u_address: address, _dao_shield_payout: address, _erc20_pool_token_template_address: address) -> bool:
    pass
...
@public
def purchase_i_tokens(_expiry: uint256(sec, positional), _underlying: address, _strike_price: uint256, _fee_in_l_token: uint256) -> bool:
    pass

@public
def purchase_s_tokens(_expiry: uint256(sec, positional), _underlying: address, _strike_price: uint256, _fee_in_l_token: uint256) -> bool:
    pass

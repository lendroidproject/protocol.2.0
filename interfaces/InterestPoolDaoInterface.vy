...
@public
def initialize(_LST: address, _registry_pool_name: address, _dao_currency: address, _template_interest_pool: address, _template_token_erc20: address, _template_erc20_pool_token: address) -> bool:
    pass
...
@public
def register_pool(_accepts_public_contributions: bool, _currency: address, _name: string[64], _initial_exchange_rate: uint256, _fee_percentage_per_i_token: uint256, _mft_expiry_limit: uint256) -> bool:
    pass
...
@public
def register_mft_support(_name: string[64], _expiry: uint256(sec, positional), _f_address: address, _i_address: address) -> (bool, uint256, uint256):
    pass

@public
def deregister_mft_support(_name: string[64], _currency: address, _expiry: uint256(sec, positional)) -> bool:
    pass
...
@public
def split(_currency: address, _expiry: uint256(sec, positional), _value: uint256) -> bool:
    pass

@public
def fuse(_currency: address, _expiry: uint256(sec, positional), _value: uint256) -> bool:
    pass

...
INTEREST_POOL_DAO_MAXIMUM_MFT_SUPPORT_COUNT = 100
...
# Auction Limits
AUCTION_SLIPPAGE_PERCENTAGE = 105
AUCTION_MAXIMUM_DISCOUNT_PERCENTAGE = 40
AUCTION_DISCOUNT_DURATION = 30 * 60
...
@pytest.fixture
def Test_token_With_Zero_Supply(get_ERC20_contract):
    contract = get_ERC20_contract(
        'Test Token With Zero Supply', 'DAIZERO', 18, 0
    )
    return contract

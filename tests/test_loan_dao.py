...
def test_avail_loan(w3, get_logs,
    ...
    tx_24_hash = LoanDao.create_offer(_s_hash, _i_hash, 2, 20, 5 * 10 ** 15,
        transact={'from': High_Risk_Insurer, 'gas': 250000})
    ...
    assert LoanDao.offers__multi_fungible_currency_s_hash(1) == _s_hash
    assert LoanDao.offers__multi_fungible_currency_i_hash(1) == _i_hash
    assert LoanDao.offers__multi_fungible_currency_s_quantity(1) == 2

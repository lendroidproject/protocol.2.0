...
#
#
# def test_purchase_until_total_lend_currency_is_raised(w3, get_contract, get_logs, time_travel,
#         LST_token, Lend_token, Borrow_token, Malicious_token,
#         ERC20_library, ERC1155_library,
#         CurrencyPool_library, CurrencyDao,
#         InterestPool_library, InterestPoolDao,
...
#     _collateral_to_raise_all_lend_currency = Auction.currency_value_remaining() / Auction.current_price()
#     tx_29_hash = Auction.purchase(Web3.toWei(_collateral_to_raise_all_lend_currency, 'ether'), transact={'from': _auctioned_collateral_purchaser, 'gas': 220000})
#     tx_29_receipt = w3.eth.waitForTransactionReceipt(tx_29_hash)
#     assert tx_29_receipt['status'] == 1
#     assert Auction.currency_value_remaining() > 0
#     assert Auction.lot() > 0
...
#
#
# def test_purchase_until_total_borrow_currency_is_sold(w3, get_contract, get_logs, time_travel,
#         LST_token, Lend_token, Borrow_token, Malicious_token,
#         ERC20_library, ERC1155_library,
#         CurrencyPool_library, CurrencyDao,
#         InterestPool_library, InterestPoolDao,
...
#     assert Auction.currency_value_remaining() == 400 * 10 ** 18
#     assert Auction.lot() > 0
#     tx_29_hash = Auction.purchase_remaining_underlying(transact={'from': _auctioned_collateral_purchaser, 'gas': 280000})
#     tx_29_receipt = w3.eth.waitForTransactionReceipt(tx_29_hash)
#     assert tx_29_receipt['status'] == 1
#     assert Auction.is_active() == False
#     assert Auction.currency_value_remaining() == 0
